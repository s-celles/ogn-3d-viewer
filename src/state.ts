...
export const S: AppState = {
  ...
  showPeaks: false, peakDensity: 0.35, minimap: true, overviewHud: false, activeOnly: false, airMass: false, thermalPot: false, liftBlend: 0.5, windMode: 'off', heightRef: 'af', clockUTC: false, clock12: false,
