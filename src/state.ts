...
export const S: AppState = {
  ...
  showPeaks: false, peakDensity: 0.35, cols: false, buildings: false, minimap: true, overviewHud: false, activeOnly: false, anon: false, airMass: false, thermalPot: false, liftOn: [true, true, true, false], liftMix: [0.34, 0.33, 0.33, 0], liftCalibrate: false, heatStore: 0.5,
  wxSim: { on: false, wind: 20, dir: 270, shear: 3, nStab: 0.011, tsurf: 15, rh: 55, date: '2024-06-21', hour: 13 }, polar: { ...DEFAULT_POLAR }, nettoMode: 'off', windMode: 'off', heightRef: 'af', clockUTC: false, clock12: false, exportFmt: 'png',
