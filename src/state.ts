...
export const S: AppState = {
  ...
  showPeaks: false, peakDensity: 0.35, cols: false, minimap: true, overviewHud: false, activeOnly: false, anon: false, airMass: false, thermalPot: false, liftOn: [true, true, true, false], liftMix: [0.34, 0.33, 0.33, 0], liftCalibrate: false, heatStore: 0.5,
