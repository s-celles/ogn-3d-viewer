...
export const S: AppState = {
  ...
  showPeaks: false, peakDensity: 0.35, minimap: true, overviewHud: false, activeOnly: false, airMass: false, thermalPot: false, liftThermal: true, liftSlope: false, windMode: 'off', heightRef: 'af', clockUTC: false, clock12: false,
