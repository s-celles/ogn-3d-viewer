...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    camera: 'Caméra', follow: 'Suivre le cap', free: 'Libre', subject: 'Planeur suivi', bank: "Inclinaison de l'horizon",
  ...
  en: {
    ...
    camera: 'Camera', follow: 'Lock to heading', free: 'Free look', subject: 'Followed glider', bank: 'Horizon banking',
