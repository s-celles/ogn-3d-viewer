...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    exo: 'Exagération du relief vertical :', groundZoom: 'Résolution du sol :', acScale: 'Taille des aéronefs (vue courante) :', gaze: 'Regard (assiette caméra) :',
  ...
  en: {
    ...
    exo: 'Vertical terrain exaggeration:', groundZoom: 'Ground resolution:', acScale: 'Aircraft size (current view):', gaze: 'Gaze (camera tilt):',
  ...
  de: {
    ...
    exo: 'Vertikale Geländeüberhöhung:', groundZoom: 'Bodenauflösung:', acScale: 'Luftfahrzeuggröße (aktuelle Ansicht):', gaze: 'Blick (Kameraneigung):',
  ...
  es: {
    ...
    exo: 'Exageración vertical del relieve:', groundZoom: 'Resolución del suelo:', acScale: 'Tamaño de las aeronaves (vista actual):', gaze: 'Mirada (inclinación de cámara):',
  ...
  it: {
    ...
    exo: 'Esagerazione verticale del rilievo:', groundZoom: 'Risoluzione del suolo:', acScale: 'Dimensione degli aeromobili (vista corrente):', gaze: 'Sguardo (inclinazione camera):',
