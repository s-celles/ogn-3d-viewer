...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    shadows: 'Ombres au sol', shadowOff: 'Désactivées', shadowNadir: 'Verticale', shadowSun: 'Soleil',
  ...
  en: {
    ...
    shadows: 'Ground shadows', shadowOff: 'Off', shadowNadir: 'Vertical', shadowSun: 'Sun',
  ...
  de: {
    ...
    shadows: 'Bodenschatten', shadowOff: 'Aus', shadowNadir: 'Vertikal', shadowSun: 'Sonne',
