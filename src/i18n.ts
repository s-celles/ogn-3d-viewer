...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    loadIgc: '📂 Fichier IGC…', igcHint: 'Charger des fichiers IGC locaux (ou glissez-les sur la carte)', igcNone: 'Aucun fichier .igc.', igcSkipped: 'ignoré(s)',
  ...
  en: {
    ...
    loadIgc: '📂 IGC file…', igcHint: 'Load local IGC files (or drop them on the map)', igcNone: 'No .igc file.', igcSkipped: 'skipped',
  ...
  de: {
    ...
    loadIgc: '📂 IGC-Datei…', igcHint: 'Lokale IGC-Dateien laden (oder auf die Karte ziehen)', igcNone: 'Keine .igc-Datei.', igcSkipped: 'übersprungen',
