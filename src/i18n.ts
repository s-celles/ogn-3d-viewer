...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    camera: 'Caméra', follow: 'Suivre le cap', free: 'Libre', subject: 'Planeur suivi', bank: "Inclinaison de l'horizon", sound: 'Son du vario', antiColl: 'Anti-collision', traffic: 'Trafic', graphs: 'Graphes', speed: 'Vitesse', graphsOff: 'Désactivés',
  ...
  en: {
    ...
    camera: 'Camera', follow: 'Lock to heading', free: 'Free look', subject: 'Followed glider', bank: 'Horizon banking', sound: 'Vario sound', antiColl: 'Collision avoidance', traffic: 'Traffic', graphs: 'Graphs', speed: 'Speed', graphsOff: 'Off',
  ...
  de: {
    ...
    camera: 'Kamera', follow: 'Kurs folgen', free: 'Freie Sicht', subject: 'Verfolgtes Segelflugzeug', bank: 'Horizontneigung', sound: 'Vario-Ton', antiColl: 'Kollisionswarnung', traffic: 'Verkehr', graphs: 'Diagramme', speed: 'Geschw.', graphsOff: 'Aus',
