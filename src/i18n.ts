...
export const I18N: Record<Lang, Strings> = {
  fr: {
    ...
    camera: 'Caméra', follow: 'Suivre le cap', free: 'Libre', subject: 'Planeur suivi', bank: "Inclinaison de l'horizon", sound: 'Son du vario', graphs: 'Graphes', speed: 'Vitesse', graphsOff: 'Désactivés',
  ...
  en: {
    ...
    camera: 'Camera', follow: 'Lock to heading', free: 'Free look', subject: 'Followed glider', bank: 'Horizon banking', sound: 'Vario sound', graphs: 'Graphs', speed: 'Speed', graphsOff: 'Off',
  ...
  de: {
    ...
    camera: 'Kamera', follow: 'Kurs folgen', free: 'Freie Sicht', subject: 'Verfolgtes Segelflugzeug', bank: 'Horizontneigung', sound: 'Vario-Ton', graphs: 'Diagramme', speed: 'Geschw.', graphsOff: 'Aus',
