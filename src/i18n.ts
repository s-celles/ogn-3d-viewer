...
export const I18N: Record<Lang, Strings> = {
  ...
  es: {
    ...
    exo: 'Exageración vertical del relieve:', acScale: 'Tamaño de las aeronaves (vista actual):', gaze: 'Mirada (inclinación de cámara):',
  ...
  it: {
    ...
    exo: 'Esagerazione verticale del rilievo:', acScale: 'Dimensione degli aeromobili (vista corrente):', gaze: 'Sguardo (inclinazione camera):',
