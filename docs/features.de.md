...
- **Aufwindpotenzial** *(optional, standardmäßig aus, experimentell)* — physikalische Schätzung, **wo die Luft steigt**: **Thermik** (Sonne × Hang × Wärmefluss → w\*, mit OSM-Landbedeckung Albedo/Bowen) und **Hangaufwind** (Wind × Gelände), per Schieberegler **gemischt**. Warmes Feld (es steigt) über das Gelände gelegt, farblich stimmig mit den Hangbändern. **Sehr grobes Modell** (siehe *Hinweise & Grenzen*).
