...
- **Wetter-Sandbox** *(optional, standardmäßig aus)* — ersetzt das abgerufene Wetter durch eine **synthetische Atmosphäre** (Windgeschwindigkeit / -richtung / -scherung, Stabilität N, Bodentemperatur) und eine wählbare **Sonnen-Datum/-Zeit**, um „Was-wäre-wenn“-Situationen zu erkunden — z. B. einen Wellentag erzwingen und Onde-Bänder, Tagesstruktur-Emagramm und Wellen-Scan reagieren sehen. Speist **alle** physikalischen Modelle; **Thermiktag- / Wellentag-Presets** (beide brauchen gegensätzliche Atmosphären — stabil+windig für Welle, labil+warm für Thermik) und ein Reset stehen bereit; ein **⚠ simuliert**-Banner markiert den Modus. Illustrativ, keine Vorhersage.
