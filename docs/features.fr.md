...
- **Cols exploitables** *(optionnel)* — marque les cols (points de selle du MNT) que le vent **traverse** — là où il s'engouffre (venturi) et où la portance de pente se construit à l'amont. Chacun montre un trait de crête et une **flèche du vent traversant**, verte quand ce vent est fort, et n'apparaît que si le vent franchit réellement le col (donc réagit quand tu changes le vent simulé).
