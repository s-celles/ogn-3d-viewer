// ============ config ============
// FlightBook expose an opened CORS (access-control-allow-origin: *) : direct call is possible.
...
export const PALETTE = [[255,140,0],[60,180,255],[160,120,255],[120,230,120],[255,90,160],
...
export const clampv = (v,a,b) => Math.max(a, Math.min(b, v));
