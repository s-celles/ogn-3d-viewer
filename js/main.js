...
import { initDeck, render } from './render.js';
import { applyI18n, applyFollowClass, syncUI, easeCamera, updateCompass } from './ui.js';
// data.js is imported for its side-effect-free wiring; ui.js already pulls it in,
// but importing here keeps the dependency explicit.
import './data.js';
