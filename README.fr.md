...
- **Chargement** — recherche d'aérodrome (code OACI ou national/FAA), **mode direct** temps réel, import de traces **IGC / GPX / KML** et de waypoints SeeYou **`.cup`**, **découverte de spots** mondiaux par continent (records, championnats) — la liste est un [Tabular Data Package](data/spots/spots.csv) maintenu par `just check-spots` — et **points chauds en direct** classant où les planeurs volent en ce moment. L'appli s'ouvre sur cette page Découvrir (l'écran d'accueil) ; cliquer un point chaud charge la journée de l'aérodrome réel le plus proche — même les zones nommées d'après un récepteur OGN sont résolues vers un aérodrome FlightBook.
